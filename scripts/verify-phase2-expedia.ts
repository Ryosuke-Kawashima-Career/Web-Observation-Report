 ...
 *
 * Usage:
 *   npx tsx scripts/verify-phase2-expedia.ts
 *
...
const TARGET_NAME = 'Expedia';
const TARGET_URL = 'https://www.expedia.com';
...
async function main() {
  ...
  let comparisonId;
  try {
    comparisonId = ComparisonService.create({
      targetId,
    ...
    console.error(`[db] Error saving comparison record`, e);
  }
